              ...
              <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-12 p-8 md:p-12">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                    ...
                    <a href={creadora.instagram.url} target="_blank" rel="noopener noreferrer" className="oc-pulsable border-2 border-white/25 hover:border-marca hover:text-marca text-white font-sarabun font-bold uppercase tracking-wider text-xs px-6 py-3.5 rounded-[16px] inline-flex items-center justify-center gap-2 transition-colors duration-200 cursor-pointer">
