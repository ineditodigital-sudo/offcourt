  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        ...
        {/* Mission */}
        <div className="mvv-card group rounded-[24px] p-8 md:p-10 border border-neutral-200 dark:border-white/5 bg-neutral-50 dark:bg-[#1A1A1A] hover:border-[#B79657]/30 dark:hover:border-[#B79657]/30 hover:-translate-y-2 transition-[transform,border-color,box-shadow] duration-500 hover:shadow-[0_0_40px_rgba(183,150,87,0.15)] relative overflow-hidden">
